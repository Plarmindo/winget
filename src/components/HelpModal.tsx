...
export const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose, onOpenSettings }) => {
  ...
  const HELP_TOPICS = useMemo<HelpTopic[]>(
    () => [
      // --- ESSENTIALS ---
      {
        id: 'getting-started',
        ...
        steps: [
          {
            ...
            description:
              'It is a power-user interface for the official Windows Package Manager (winget). We unify multiple sources to let you manage software easily.',
            visualType: 'search',
          },
          {
            title: 'Installation Modes',
            description:
              'Use the top navigation bar to switch between main tasks:\n• Discover: Find and install new apps.\n• Upgrades: Check for newer versions of your installed software.\n• Installed: View and remove (uninstall) existing apps.',
            visualType: 'modes',
          },
        ],
      },
        ...
        steps: [
          {
            ...
            description:
              'When you search, we query both the "Winget" repository (community maintained) and the "Microsoft Store" simultaneously. You choose the best source.',
            visualType: 'providers',
          },
          {
            title: 'Smart Search',
            description:
              'Just type! Use keywords like "vscode" or "browser". You can also search by ID (e.g., "Mozilla.Firefox") for precision.',
            visualType: 'search',
          },
          {
            title: 'Bulk Selection',
            description:
              "Don't install one by one. Check the boxes next to multiple apps to add them to your cart, then install them all at once.",
            visualType: 'cart',
          },
        ],
      },
        ...
        steps: [
          {
            ...
            description:
              'Switch to the "Upgrades" tab. We scan your system for outdated apps. Click "Upgrade All" to update everything in one click.',
            visualType: 'upgrade',
          },
          {
            title: 'Uninstalling',
            description:
              'Go to the "Installed" tab to see everything on your PC. Click the trash icon next to any app to remove it cleanly.',
      ...
      // --- GITHUB INTEGRATION ---
      {
        ...
        steps: [
          ...
          },
          {
            ...
            description:
              'Not just popular apps! You can type "user/repo" (e.g., "marticliment/WingetUI") to access specific repositories that might not be in the main gallery.',
            action: { label: 'Try GitHub Search', action: 'github' },
          },
          {
            title: 'Hybrid Comparison',
            description:
              'Compare a GitHub repo against a standard Winget package to decide between the stable release or the bleeding-edge source.',
        ...
        steps: [
          {
            ...
            description:
              'Expand any card to see an AI-generated summary. We read the manifest and description to tell you what the app REALLY does.',
            visualType: 'ai-summary',
          },
          {
            title: 'Contextual Chat',
            description:
              'Open the sidebar chat to ask complex questions like "Which video editor is best for 4K?" or "Explain the difference between these two git clients".',
            visualType: 'ai-chat',
          },
        ],
      },
        ...
        steps: [
          {
            ...
            description:
              'Every app you select is added to your efficient "Shopping Cart". Open it via the header icon.',
            visualType: 'cart',
          },
          {
            title: 'Export to Batch/PowerShell',
            description:
              'In the cart, use "Generate Script" to get a .bat or .ps1 file. Run this file on a fresh Windows installation to auto-install your entire suite.',
            visualType: 'script',
          },
        ],
      },
      {
        ...
        steps: [
          ...
          },
          {
            title: 'Analyze',
            description:
              'Add up to 4 apps. Click "Compare" to generate a detailed table comparing features, license, size, and AI-generated pros/cons.',
          },
        ],
      },
        ...
        steps: [
          {
            ...
            description:
              'Ensure "App Installer" is updated in the Microsoft Store. This app relies on the core Winget CLI tool.',
            action: { label: 'Get App Installer', url: 'ms-windows-store://pdp/?productid=9nblggh4nns1' },
          },
          {
            title: 'GitHub API Limits',
            description:
              'If GitHub search stops working, you have hit the unauthenticated rate limit. Go to Settings and add a Personal Access Token to increase your limit significantly.',
        ...
        steps: [
          {
            title: 'Is it safe?',
            description:
              'Yes. All packages come from the official Microsoft Winget repository or the Microsoft Store. We effectively just run the command line for you.',
          },
          {
            title: 'Can I backup my current apps?',
            description:
              'Currently we support exporting a list of *new* installations. Full system backup is planned for v2.0.',
          },
          {
            title: 'Why is AI required?',
            description:
              'It is optional! You can use the app without AI, but summaries and chat features will be disabled. You can use local LLMs via Ollama for privacy.',
          },
          {
            title: 'Where is the dark mode?',
            description: 'In Settings! We respect your system preference by default but you can force Dark/Light mode.',
            action: { label: 'Change Theme', action: 'settings' },
          },
        ],
      },
    ],
        ...
        return (
          <div className="flex items-center justify-center h-full bg-gray-50 dark:bg-gray-900/50 p-4">
            <div className="flex bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-1">
              <div className="px-3 py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 rounded text-[10px] font-bold">
                Discover
              </div>
        ...
        return (
          <div className="flex items-center justify-center gap-8 h-full bg-gray-50 dark:bg-gray-900/50 relative overflow-hidden">
            ...
            <div className="h-0.5 w-16 bg-gray-300 dark:bg-gray-700 relative">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 px-2 text-[8px] text-gray-400 font-bold border border-gray-200 dark:border-gray-700 rounded-full">
                ALL IN ONE
              </div>
            </div>
            <div className="flex flex-col items-center gap-2 z-10">
        ...
        return (
          <div className="p-4 flex flex-col gap-3 max-w-[240px] w-full mx-auto bg-gray-50 dark:bg-gray-900/50 h-full justify-center">
            <div className="flex gap-2 items-end self-start w-3/4">
              <div className="w-6 h-6 rounded-full bg-purple-600 shrink-0 flex items-center justify-center text-[8px] text-white">
                AI
              </div>
              <div className="bg-purple-100 dark:bg-purple-900/30 p-2 rounded-2xl rounded-bl-sm text-[10px] text-purple-900 dark:text-purple-100 leading-tight">
                {type === 'ai-summary'
                  ? 'This package contains the VS Code editor...'
                  : 'The best option for 4K video editing is...'}
              </div>
            </div>
      ...
      case 'script':
        return (
          <div className="w-full h-full bg-[#1e1e1e] p-4 font-mono text-[10px] text-gray-300 overflow-hidden flex flex-col font-mono leading-relaxed">
            ...
            <div>
              <span className="text-green-400">winget</span> install --id &quot;Mozilla.Firefox&quot;
            </div>
            <div>
              <span className="text-blue-400">Downloading</span> Mozilla Firefox...
            </div>
      ...
      >
        ...
        <div className="w-72 bg-[var(--app-bg)] border-r border-[var(--app-border)] flex flex-col shrink-0">
                  ...
                  <div key={cat}>
                    ...
                    <div className="space-y-1">
                      {topics.map((topic) => (
                        ...
                        >
                          <span className={activeTopicId === topic.id ? 'text-white' : 'text-[var(--app-text-muted)]'}>
                            {topic.icon}
                          </span>
          ...
          <div className="p-4 border-t border-[var(--app-border)] bg-[var(--app-bg)]/50">
            <button
              onClick={() => window.open('https://github.com/marticliment/WingetUI', '_blank')}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-[var(--app-border)] text-xs font-medium text-[var(--app-text-muted)] hover:bg-[var(--app-surface)] hover:text-[var(--app-text)] transition-colors"
            >
        ...
        <div className="flex-1 flex flex-col h-full bg-[var(--app-surface)] relative overflow-hidden">
          ...
          <div className="px-8 py-6 border-b border-[var(--app-border)] flex justify-between items-start bg-[var(--app-bg)]/10 backdrop-blur-sm sticky top-0 z-10">
              ...
              <div className="flex items-center gap-2 mb-3">
                <span
                  className={`px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-wider border ${
                    activeTopic.category === 'troubleshooting'
                      ? 'bg-red-500/10 text-red-500 border-red-500/20'
                      : activeTopic.category === 'advanced'
                        ? 'bg-purple-500/10 text-purple-500 border-purple-500/20'
                        : activeTopic.category === 'github'
            ...
            <button
              onClick={onClose}
              className="p-2 -mr-2 -mt-2 rounded-full hover:bg-[var(--app-border)] transition-colors"
          ...
          <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
              ...
              {activeTopic.category === 'faq' ? (
                <div className="grid gap-4">
                  {activeTopic.steps.map((step, i) => (
                    <div
                      key={i}
                      className="border border-[var(--app-border)] rounded-xl overflow-hidden bg-[var(--app-surface)] hover:border-[var(--app-primary)]/30 transition-colors shadow-sm"
                    >
                      <button
                      ...
                      >
                        {step.title}
                        <div
                          className={`w-6 h-6 rounded-full bg-[var(--app-bg)] flex items-center justify-center transition-transform duration-300 ${expandedFaq === i.toString() ? 'rotate-180 bg-[var(--app-primary)] text-white' : ''}`}
                        >
                          <ChevronDown size={14} />
                        </div>
                      </button>
                      <div
                        className={`overflow-hidden transition-all duration-300 ease-in-out ${expandedFaq === i.toString() ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}
                      >
                  ...
                  {activeTopic.steps.map((step, index) => (
                    <div key={index} className="flex gap-8 group">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[var(--app-text-muted)] leading-relaxed whitespace-pre-wrap">
                          {step.description}
                        </p>
            ...
            <div className="mt-12 pt-8 border-t border-[var(--app-border)] flex justify-between items-center text-xs text-[var(--app-text-muted)]">
              ...
              <div className="flex gap-4">
                <button className="hover:text-[var(--app-primary)] flex items-center gap-1 transition-colors">
                  <Check size={14} /> Yes
                </button>
