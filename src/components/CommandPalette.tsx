...
export const CommandPalette: React.FC<CommandPaletteProps> = ({ isOpen, onClose, inputRef, searchTerm, setSearchTerm, commands }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-start justify-center pt-[20vh]" onClick={onClose}>
      <div 
