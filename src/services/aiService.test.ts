...
describe('aiService', () => {
    ...
    describe('detectTaskComplexity', () => {
        ...
        it('should return "complex" for long messages', () => {
            const longMessage = 'This is a very long message that contains a lot of words and should definitely be classified as complex because it exceeds 80 characters';
