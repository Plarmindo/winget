...
- Name: playwright.ai-settings.test.ts >> AI Settings - Local Model Management >> should initialize model on chat if not loaded
- Location: tests\playwright.ai-settings.test.ts:107:3
