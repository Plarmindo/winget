...
- Name: playwright.ai-settings.test.ts >> AI Settings - Local Model Management >> should unload model successfully
- Location: tests\playwright.ai-settings.test.ts:81:3
