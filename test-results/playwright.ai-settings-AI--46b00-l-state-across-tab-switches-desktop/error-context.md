...
- Name: playwright.ai-settings.test.ts >> AI Settings - Local Model Management >> should maintain model state across tab switches
- Location: tests\playwright.ai-settings.test.ts:53:3
