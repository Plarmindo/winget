...
- Name: playwright.ai-settings.test.ts >> AI Settings - Error Handling >> should handle invalid model files gracefully
- Location: tests\playwright.ai-settings.test.ts:173:3
