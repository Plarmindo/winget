...
- Name: playwright.ai-settings.test.ts >> AI Settings - Local Model Management >> should persist local model configuration across app restart
- Location: tests\playwright.ai-settings.test.ts:137:3
...
Call log:
  - waiting for locator('[data-testid="app-container"]') to be visible
