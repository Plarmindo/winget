  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-8 animate-in fade-in zoom-in-95 duration-300">
       ...
       <div>
           ...
           <p className="text-[var(--app-primary)] font-mono text-sm bg-[var(--app-primary)]/10 px-3 py-1 rounded-full inline-block mb-4">v1.5.0 • Stable</p>
           <p className="text-[var(--app-text-muted)] max-w-sm mx-auto leading-relaxed">
              A sovereign, intelligent interface for package management. 
              Designed for power users who prefer visual discovery over CLI memorization.
           </p>
       </div>

       <div className="grid grid-cols-2 gap-4 w-full max-w-md">
           <a href="#" className="p-4 bg-[var(--app-bg)] hover:bg-[var(--app-surface)] border border-[var(--app-border)] rounded-xl flex flex-col items-center gap-2 transition-all hover:border-[var(--app-primary)] group">
       ...
       <div className="text-[10px] text-[var(--app-text-muted)] opacity-50">
          MIT License • Built with React & Rust
       </div>
    </div>
  );
};
